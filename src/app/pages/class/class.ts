...
export class Class {
 ...
 constructor() {
  effect(() => {
   ...
   this.filteredClasses =
    this.selectedField === 'all' ? this.classes : this.classes.filter(c => c.fieldId === this.selectedField);
  });
 }
 ...
 onFieldSelected(field: Field) {
  ...
  this.filteredClasses = field.id === 'all' ? this.classes : this.classes.filter(c => c.fieldId === this.selectedField);
 }
